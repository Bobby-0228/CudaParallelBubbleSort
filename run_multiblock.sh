...
## Script will compile and execute bubble_multiblock.cu and compare the resulting outputs with golden using the "diff" command
## EXAMPLE: run_multiblock.sh array1.txt golden1.txt
